...
function buildLinkRefs(content, newVersion, repoUrl) {
...
async function updateChangelog(newVersion, lastTag, commits, owner, repo, _defaultBranch = "main") {
  ...
  content = buildLinkRefs(content, newVersion, repoUrl);
